describe('NG2 Article Ads:', function() {
    ...
    it('should have recx-1 ad', function() {
        ...
        expect(browser.executeScript('return window.Object.values(googletag.pubads().getSlots())[8].getContentUrl()')).toContain('scp=pos%3Drecx%26recx%3D1');
    ...
    it('should have recx-2 ad', function() {
        ...
        expect(browser.executeScript('return window.Object.values(googletag.pubads().getSlots())[9].getContentUrl()')).toContain('scp=pos%3Drecx%26recx%3D2');
