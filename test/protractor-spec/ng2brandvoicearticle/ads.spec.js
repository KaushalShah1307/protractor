describe('NG2 BrandVoice Article Ads:', function() {
    ...
    it('should have loge ad', function() {
        ...
        expect(browser.executeScript('return window.Object.values(googletag.pubads().getSlots())[2].V')).toContain('scp=pos%3Dloge');
        expect(browser.executeScript('return window.Object.values(googletag.pubads().getSlots())[2].V')).toContain('sz=300x600%7C300x250%7C1x1');
    ...
    it('should have top ad', function() {
        ...
        expect(browser.executeScript('return window.Object.values(googletag.pubads().getSlots())[1].V')).toContain('scp=pos%3Dtop');
        expect(browser.executeScript('return window.Object.values(googletag.pubads().getSlots())[1].V')).toContain('sz=728x90%7C970x250%7C970x90%7C970x66%7C640x360%7C1x1');
    ...
    it('should have rec ad', function() {
        ...
        expect(browser.executeScript('return window.Object.values(googletag.pubads().getSlots())[3].V')).toContain('scp=pos%3Drec');
        expect(browser.executeScript('return window.Object.values(googletag.pubads().getSlots())[3].V')).toContain('sz=300x250%7C336x280%7C300x600%7C336x850%7C450x254%7C1x1');
        expect(browser.executeScript('return window.Object.values(googletag.pubads().getSlots())[3].V')).toContain('iu=%2F7175%2Ffdc.forbes%2Farticle-d-delta-u');
    });
    ...
    it('should have recx-1 ad', function() {
        ...
        expect(browser.executeScript('return window.Object.values(googletag.pubads().getSlots())[4].V')).toContain('scp=pos%3Drecx%26recx%3D1');
        expect(browser.executeScript('return window.Object.values(googletag.pubads().getSlots())[4].V')).toContain('sz=300x250%7C336x280%7C300x600%7C336x850%7C450x254%7C1x1');
        expect(browser.executeScript('return window.Object.values(googletag.pubads().getSlots())[4].V')).toContain('iu=%2F7175%2Ffdc.forbes%2Farticle-d-delta-u');
    });
